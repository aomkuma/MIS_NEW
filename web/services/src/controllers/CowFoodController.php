<?php
    ...
    use App\Service\CowFoodService;
    ...
    class CowFoodController extends Controller {
        ...
        public function getList($request, $response, $args){
            try{
                ...
                $_List = CowFoodService::getList($actives);
        ...
        public function getData($request, $response, $args){
            try{
                ...
                $_Data = CowFoodService::getData($id);
        ...
        public function updateData($request, $response, $args){
            ...
            try{
                ...
                // print_r($_Data);exit;
                // // Update to none role
                $id = CowFoodService::updateData($_Data);
        ...
        public function removeData($request, $response, $args){
            try{
                ...
                $result = CowFoodService::removeData($id);
