<?php
    ...
    class CowBreedController extends Controller {
        ...
        public function getMonthDataList($condition, $regions){
            ...
            // get master goal
            $MasterGoalList = MasterGoalService::getList('Y', 'ปัจจัยการเลี้ยงดูโค (เคมีภัณฑ์)');
    ...
    private function getMonthDetailList($condition, $regions, $description) {
        ...
        $MasterList = MasterGoalService::getList('Y', 'ปัจจัยการเลี้ยงดูโค (เคมีภัณฑ์)');
        ...
        foreach ($MasterList as $key => $value) {
            ...
            // get unit list by id
            $UnitList = CowBreedService::getUnitList($years, $months, $region_id, $value['id']);
            ...
            foreach ($UnitList as $unit_key => $unit_value) {
                ...
                foreach ($CooperativeList as $co_key => $co_value) {
                    ...
                    $detail_data = CowBreedService::getDetailData($years, $months, $region_id, $cooperative_id, $value['id'], $unit_value['amount_unit']);
